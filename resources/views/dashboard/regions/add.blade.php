        ...
        <div class="panel panel-default">
            ...
            <div class="panel-wrapper collapse in">
                ...
                <div class="panel-body">
                    <form action="{{Route('create_regions',['ru'])}}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                        @csrf
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="home1">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="name_uz" required placeholder="@lang('admin.titlee')" class="form-control"> <!--span class="help-block"> This is inline help </1--span --> </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="full_text_uz" id="editor1" rows="10" cols="80"></textarea>
                                                </div>
                                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="profile1">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">@lang('admin.titlee')</label>
                                            <div class="col-md-9">
                                                <input type="text" name="name_ru" required placeholder="@lang('admin.titlee')" class="form-control"> <!--span class="help-block"> This is inline help </1--span --> </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-3">@lang('admin.opi')</label>
                                            <div class="col-md-9">
                                                    <textarea name="full_text_ru" id="editor2" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="messages1">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">@lang('admin.titlee')</label>
                                            <div class="col-md-9">
                                                <input type="text" name="name_en" required placeholder="@lang('admin.titlee')" class="form-control"> <!--span class="help-block"> This is inline help </1--span --> </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="control-label col-md-3">@lang('admin.opi')</label>
                                            <div class="col-md-9">
                                                    <textarea name="full_text_en" id="editor3" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
