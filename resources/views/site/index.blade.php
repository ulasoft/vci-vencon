            ...
            <div class="container">
                ...
                <div class="first">
                    ...
                    <div class="responsive-nav">
                        ...
                        <ul class="main-ul">
                            <li><a href="#">@lang('s.home')</a></li>
                            <li><a href="regions.html">@lang('s.regions')</a></li>
                            ...
                            <span class="dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
										<a class="dropdown-item" href="#"><img src="/img/rus.png" alt="rus" class="img-width"> РУС</a>
										<a class="dropdown-item" href="#"><img src="/img/uzb.png" alt="uzb" class="img-width"> UZB</a>
									</div>
								</span><!-- dropdown -->
                        </ul><!-- main-ul -->
                    ...
                    <div class="not-responsive-nav">
                        <div class="container d-flex space-between">
                            ...
                            <ul class="desktop-ul d-flex">
                                ...
                                <span class="dropdown">
										<a class="dropdown-toggle dropdown-link desktop-dropdown" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
											<img src="/img/eng.png" alt="eng" class="img-width">
										</a>
										<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
											<a class="dropdown-item" href="#"><img src="/img/rus.png" alt="rus" class="img-width"> РУС
											</a>
											<a class="dropdown-item" href="#"><img src="/img/uzb.png" alt="uzb" class="img-width"> UZB
											</a>
										</div>
									</span><!-- dropdown -->
                            </ul><!-- desktop-ul -->
                ...
                <div class="grid steve-p">
                    <figure class="effect-steve">
                        ...
                        <figcaption>
                            ...
                            <p>@lang('s.res_text')</p>
                            <a href="restaurants.html">@lang('s.more')</a>
                        </figcaption>
                    </figure>
                </div>
            </div>
                ...
                <div class="grid steve-p responsive-margin">
                    <figure class="effect-steve">
                        ...
                        <figcaption>
                            ...
                            <a href="hotels.html">@lang('s.more')</a>
                        </figcaption>
                    </figure>
                </div>
            </div><!-- end -->
                ...
                <div class="grid steve-p">
                    <figure class="effect-steve">
                        ...
                        <figcaption>
                            ...
                            <a href="entertainment.html">@lang('s.more')</a>
                        </figcaption>
                    </figure>
                </div>
            </div><!-- end -->
    ...
    <div class="container-fluid pt-4 pb-4 bg">
        <div class="container">
            <div class="col-md-12 mx-auto text-center">
                ...
                <p class="m-0 pb-3">
                    <a href="index.html" class="footer-link"><span class="pp wow bounceInLeft" data-wow-offset="0">@lang('s.home')</span></a>
                    <a href="regions.html" class="footer-link wow bounceInLeft" data-wow-offset="0"><span class="pp">@lang('s.regions')</span></a>
